...
/*
Updated 10/29/2020 because Thein was having issues importing from excel. She entered in 11/19/2020 but it changed it to 11/18/2020 because of the EDT vs EST
...
function write_ws_xml_datavalidation(validations) {
	...
	for(var i=0; i < validations.length; i++) {
		...
		//o += '<dataValidation type="list" allowBlank="0" sqref="' + validation.sqref + '">';
		o += '<dataValidation type="list" allowBlank="false" showInputMessage="true" prompt="" promptTitle="" showErrorMessage="true" error="The value you entered is incorrect. Please use the dropdown values." errorTitle="Error" operator="" sqref="' + validation.sqref + '">';
...
var zip, d = data;
	...
	switch(o.type) {
		case "base64": zip = new JSZipSync(d, { base64:true }); break;
		case "binary": case "array": zip = new JSZipSync(d, { base64:false }); break;
		case "buffer": zip = new JSZipSync(d); break;
